...
$(function(){
    $.ajax({
        ...
        success:function(data){
            ...
            var mealtxt = ''
            mealtxt += data.username +'님 지금까지 식단목표를 '+mealpercentage+'% 달성중입니다.'
            if (mealpercentage > 80){
                mealtxt +='<br>너무 잘하고 계세요. 지금처럼 계속 꾸준히 해주시면 원하시는 목표를 금방 이루실거에요 :) <br> <br>'
            }
            else if (mealpercentage > 50){
                mealtxt +='<br>원하시는 목표위해서 조금만 더 분발해주세요 :) 화이팅 ! <br> <br>'
            }
            else{
                mealtxt +='<br>혹시 너무 무리한 목표설정이 아니신가요? 회원정보 수정에서 목표일을 변경하실 수 있습니다-. :) <br><br>'

            }
            mealtxt+='<li>평균적으로 아침, 점심, 저녁, 간식을 '+ data.minfo.blds_ratio +'의 비율로 섭취하고 있으며,</li>'
            mealtxt+='<li>하루평균 '+ data.minfo.avgDCal +'칼로리를 섭취하고 있어요</li>'
            ...
            if (exerpercentage > 80){
                exertxt +='<br>너무 잘하고 계세요. 지금처럼 계속 꾸준히 해주시면 원하시는 목표를 금방 이루실거에요 :) <br> <br>'
            }
            else if (exerpercentage > 50){
                exertxt +='<br>원하시는 목표위해서 조금만 더 분발해주세요 :) 화이팅 ! <br> <br>'
            }
            else{
                exertxt +='<br>혹시 너무 무리한 목표설정이 아니신가요? 회원정보 수정에서 목표일을 변경하실 수 있습니다.  :) <br><br>'

            }

            exertxt +='<li>현재까지 유산소 운동 '+ data.einfo.aerobic[1]+'분, 근력운동 '+data.einfo.aerobic[3] +'분 하셨어요. </li>'
            exertxt +='<li>그 결과 유산소 운동으로 '+ data.einfo.aerobic[4]+'칼로리를 소모하시고 근력운동으로 '+data.einfo.aerobic[5] +' 칼로리를 소모하셨어요. </li>'
